...
Процедура ИнициализацияФормы()
	...
	Если ПравоДоступа("Изменение", Метаданные.БизнесПроцессы.СогласованиеЗаявкиНаСделку) Тогда
...
Процедура УстановитьСостояниеЭлементов()
	...
	БизнесПроцессы.СогласованиеЗаявкиНаСделку.УстановитьСостояниеЭлементовФормыЗадачи(ЭтотОбъект);
