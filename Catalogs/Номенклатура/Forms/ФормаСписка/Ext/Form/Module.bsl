...
Процедура АктуализироватьКомплектыНаСервере()
	...
	|	МИНИМУМ(НоменклатураКомплектующие.Номенклатура.Актуальная) КАК НоменклатураАктуальная,
	...
	|
	|ИМЕЮЩИЕ
	|	МИНИМУМ(НоменклатураКомплектующие.Номенклатура.Актуальная) <> НоменклатураКомплектующие.Ссылка.Актуальная";
