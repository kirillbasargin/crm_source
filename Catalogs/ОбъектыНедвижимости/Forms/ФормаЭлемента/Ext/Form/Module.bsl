...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	//Если Пользователи.РолиДоступны("РедактированиеОписанияОН") И НЕ Пользователи.ЭтоПолноправныйПользователь() Тогда	
	//	Элементы.ГруппаШапка.ТолькоПросмотр = Истина;
	//	Элементы.ГруппаОсновнаяПанель.ТолькоПросмотр = Истина;
