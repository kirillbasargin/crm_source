...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	//EXTCODE Шумилин Сергей 06.06.2017 {{ --->
	Разделы.Добавить(Метаданные.Подсистемы.РаботаСКлиентами, 
						"Отчеты по подбору ОН");
	//EXTCODE Шумилин Сергей 06.06.2017 <--- }} 
КонецПроцедуры
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	//EXTCODE Шумилин Сергей 06.06.2017 {{ --->
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.Квартирограмма);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.Шахматка);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЭффективностьМенеджера);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетПоВыданнымПодаркам);
	//EXTCODE Шумилин Сергей 06.06.2017 <--- }} 
