...
Процедура ОбработатьОбъектСПерехватомСообщений(Знач Объект, Знач Действие, Знач РежимЗаписи, Знач ПараметрыЗаписи)
	...
	Попытка
		...
		//EXTCODE Шумилин Сергей 26.02.2018 {{ ---> Обработка по замене ссылок не должна менять ответственного
		Объект.ДополнительныеСвойства.Вставить("СистемноеПроведение", Истина);
		//EXTCODE Шумилин Сергей 26.02.2018 <--- }} 
