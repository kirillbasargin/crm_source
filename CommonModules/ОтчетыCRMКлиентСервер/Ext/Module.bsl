////////////////////////////////////////////////////////////////////////////////
// Подсистема "Отчеты CRM" (клиент и сервер).
// 
////////////////////////////////////////////////////////////////////////////////
...
Функция РучнаяКорректировкаНаименованияДоступныхПолейСКД(Знач ИмяПоля) Экспорт

	//Исключения
	Если СтрНайти(ИмяПоля," мин-макс")>0 Тогда
		ИмяПоля = СтрЗаменить(ИмяПоля, " мин-макс", "");		
	КонецЕсли;
