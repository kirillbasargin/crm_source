...
Процедура ПослеФормирования(ФормаОтчета, ОтчетСформирован) Экспорт
	...
	CRMОтчетыКлиент.ПослеФормированияОтчета(ФормаОтчета, ОтчетСформирован);
	//EXTCODE Шумилин Сергей 06.03.2017 <--- }} 	
...
Процедура ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	//EXTCODE Шумилин Сергей 06.03.2017 {{ --->
	CRMОтчетыКлиент.ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка);
	//EXTCODE Шумилин Сергей 06.03.2017 <--- }} 
...
Процедура ОбработкаДополнительнойРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	//EXTCODE Шумилин Сергей 06.03.2017 {{ --->
	//CRMОтчетыКлиент.ОбработкаДополнительнойРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка);
	//EXTCODE Шумилин Сергей 06.03.2017 <--- }} 	
