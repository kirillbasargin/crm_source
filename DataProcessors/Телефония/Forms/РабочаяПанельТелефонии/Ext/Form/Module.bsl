...
Процедура КомандаУстановитьСтатусОбработано(Команда)
	...
	Если НЕ ТекущиеДанные = Неопределено Тогда	
		...
		//<828132>, Басаргин (10.09.2018) {
		ОткрытьФорму("Документ.Встреча.ФормаОбъекта", Новый Структура("Ключ, ЗавершениеВзаимодействияИзЗаявкиНаЗвонок", ТекущиеДанные.Взаимодействие, Истина));
		//<828132> }		
	КонецЕсли;	
