...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	//<828132>, Басаргин (19.06.2018) { //коммент
...
Процедура ЗаполнитьСтатусРасшифровкуСтатуса()
	...
	АктуальныеПараметрыЗапроса = РегистрыСведений.Взаимодействия.ПолучитьАктуальныеПараметрыЗапроса(Ссылка);
		
	Статус = АктуальныеПараметрыЗапроса.СтатусЗапроса;
	РасшифровкаСтатуса = АктуальныеПараметрыЗапроса.РасшифровкаСтатусаЗапроса;
	Стадия = АктуальныеПараметрыЗапроса.СтадияЗапроса;
	
	//Запрос = Новый Запрос;
	//Запрос.Текст = 	
	//"ВЫБРАТЬ ПЕРВЫЕ 1
	//|	Взаимодействия.СтатусЗапроса КАК Статус,
	//|	Взаимодействия.РасшифровкаСтатусаЗапроса КАК РасшифровкаСтатуса,
	//|	Взаимодействия.СтадияЗапроса КАК Стадия
	//|ИЗ
