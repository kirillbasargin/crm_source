...
Функция РеквизитыРедактируемыеВГрупповойОбработке() Экспорт
	...
	Результат.Добавить("КонтактноеЛицо");
...
Функция ПолучитьКонтакты(Ссылка) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	ИпотечнаяЗаявка.КонтактноеЛицо КАК Контакт,
	|	ИпотечнаяЗаявка.EmailКлиента КАК Адрес,
	|	ИпотечнаяЗаявка.НомерТелефонаКлиента КАК Представление
	|ИЗ
