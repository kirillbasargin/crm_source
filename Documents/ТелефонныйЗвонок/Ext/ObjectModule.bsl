...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если НЕ ЭтоНовый() И НЕ ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Ссылка, "ПометкаУдаления") И ПометкаУдаления Тогда
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	////<828132>, Басаргин (20.09.2018) {
	//Индекс = ПроверяемыеРеквизиты.Найти("Описание");
